...
→ trovato: grafana.planning.htb

------------------------------------------------------------------------------

[ 0x03 ] grafana.planning.htb – Authenticated RCE (CVE-2024-9264)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Grafana ≤10.2.3 vulnerabile a RCE dopo login.
PoC pubblico disponibile.

Bruteforce credenziali con rockyou.txt → admin:admin
...
[ 0x04 ] Escaping Docker – SSH as enzo
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Dentro il container:
...
[ 0x05 ] linPEAS → Port 8000 – Cronicle Dashboard
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
